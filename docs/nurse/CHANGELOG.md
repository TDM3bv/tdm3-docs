...
| 1.50   | Toevoeging: element referentieverwijsvoorschrift en flagverwijsvoorschrift op node [uitgevoerdezorg](nodes#node-uitgevoerdezorg). [Meer uitleg](/nurse/#referentienummer-digitaal-verwijsvoorschrift)                                                     |
| 1.51   | Toevoeging: elementen kanaalfactuurpatient en emailfactuurpatient op node [patientgegevens](nodes#node-patiëntgegevens) voor e-mail verzending van patiëntfacturen                                                                                      |
